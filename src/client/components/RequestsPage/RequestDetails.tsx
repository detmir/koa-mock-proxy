...
const RequestDetailsBody = ({ requestDetails }: { requestDetails?: RequestDetailsType }) => {
  if (!requestDetails) {
    return <Spin />;
  }
...
export const RequestDetails = ({ isVisible, onClose, requestDetails }: RequestDetailsProps) => (
  <Drawer
